...
| Q021 | [106, 107] | 9.3.5.7 SUBSCRIPTION_MATCHED | QUESTION_TOKEN_ABSENT | subscriptionmatched→全书零命中 |
| Q023 | [105, 105] | 9.3.5.2 LIVELINESS_CHANGED S | QUESTION_TOKEN_ABSENT | livelinesschanged→全书零命中 |
| Q026 | [106, 106] | 9.3.5.5 SAMPLE_LOST Status | QUESTION_TOKEN_OFF_PAGE | samplestatemask→实际在 [39, 40, 41, 42] |
| Q028 | [85, 85] | 8.3.5 关于DataWriter的Status | QUESTION_TOKEN_ABSENT | publicationmatched→全书零命中 |
...
| Q112 | [276, 276] | 24.2 Licence授权方式 | QUESTION_TOKEN_OFF_PAGE | license→实际在 [285, 286, 287] |
| Q114 | [248, 248] | 20.1 XML配置说明 | NO_TOKEN_PROBE | — |

## 判定码计数

- `NO_TOKEN_PROBE` = 13（指纹）
- `QUESTION_TOKEN_OFF_PAGE` = 5（阻断）
